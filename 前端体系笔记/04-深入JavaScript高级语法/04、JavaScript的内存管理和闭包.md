...
![image-20230315214052197](.\img\image-20230315214052197.png)
...
### 2.1、常见的GC算法 – 引用计数（Reference counting）
...
![image-20230315215440394](.\img\image-20230315215440394.png)



### 2.3、常见的GC算法 – 其他算法优化补充
...
V8引擎为了提供内存的管理效率，对内存进行非常详细的划分：

![image-20230315220218390](.\img\image-20230315220218390.png)
...
![image-20230319112203938](.\img\image-20230319112203938.png)

### 4.2、闭包的执行过程

![image-20230319114005842](.\img\image-20230319114005842.png)
