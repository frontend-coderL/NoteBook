...
![image-20230409221221604](.\img\image-20230409221221604.png)



### 1.3、网页的渲染过程 – 前后端分离

![image-20230409221306302](.\img\image-20230409221306302.png)
...
![image-20230409221432470](.\img\image-20230409221432470.png)
...
![image-20230409221503466](.\img\image-20230409221503466.png)
...
### 2.6、HTTP Request Header（一）

在request对象的header中也包含很多有用的信息，客户端会默认传递过来一些信息：

![image-20230409221902635](.\img\image-20230409221902635.png)
...
### 2.9、HTTP Request Header

响应的header中包括一些服务器给客户端的信息：

![image-20230409222301016](.\img\image-20230409222301016.png)

### 2.10、Chrome安装插件 - FeHelper
...
sendBtn.onclick = function () {
  ...
  xhr.open(
    "get",
    "http://123.207.32.32:1888/02_param/get?name=why&age=18&address=广州市"
  );
...
- 比如返回值是一个Promise，提供了一种更加优雅的处理结果方式
  - 在请求发送成功时，调用resolve回调then； ✓ 在请求发送失败时，调用reject回调catch；
