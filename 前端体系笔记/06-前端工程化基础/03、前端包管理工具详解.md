...
![image-20230416145208715](.\img\image-20230416145208715.png)
...
![image-20230416154010247](.\img\image-20230416154010247.png)

### 3.4、npm install 原理图解析
...
![image-20230416155859055](.\img\image-20230416155859055.png)
...
![image-20230416165202731](.\img\image-20230416165202731.png)
...
![image-20230416170423011](.\img\image-20230416170423011.png)

哪些公司在用呢？

- 包括Vue在内的很多公司或者开源项目的包管理工具都切换到了pnpm；

![image-20230416170448935](.\img\image-20230416170448935.png)
...
![image-20230416170529235](.\img\image-20230416170529235.png)

### 6.3、硬链接和软连接的演练

文件的拷贝：文件的拷贝每个人都非常熟悉，会在硬盘中复制出来一份新的文件数据；

![image-20230416171337346](.\img\image-20230416171337346.png)文件的硬链接

![image-20230416171409675](.\img\image-20230416171409675.png)

文件的软连接：

![image-20230416171430847](.\img\image-20230416171430847.png)
...
![image-20230416184933879](.\img\image-20230416184933879.png)

### 6.5、pnpm创建非扁平的 node_modules 目录

当使用 npm 或 Yarn Classic 安装依赖包时，所有软件包都将被提升到 node_modules 的 根目录下。

- 其结果是，源码可以访问 本不属于当前项目所设定的依赖包；

![image-20230416185057694](.\img\image-20230416185057694.png)
...
![image-20230416190431038](.\img\image-20230416190431038.png)
...
我们可以通过一些终端命令获取这个目录：获取当前活跃的store目录 `pnpm store path`

另外一个非常重要的store命令是prune（修剪）：从store中删除当前未被引用的包来释放store的空间 `pnpm store prune `
