...
![image-20230417203008300](.\img\image-20230417203008300.png)
...
![image-20230417204808647](.\img\image-20230417204808647.png)
...
![image-20230417204909559](.\img\image-20230417204909559.png)
...
`git config --global user.name "jiumingmao"`
...
![image-20230417211657393](.\img\image-20230417211657393.png)

### 4.5、获取Git仓库 – git init/git clone
...
![image-20230417212029817](.\img\image-20230417212029817.png)

### 5.2、Git操作流程图

![image-20230417212620994](.\img\image-20230417212620994.png)
...
![image-20230417213532040](.\img\image-20230417213532040.png)
...
![image-20230417213800616](.\img\image-20230417213800616.png)

### 5.6、文件更新提交 – git commit
...
![image-20230417214501573](.\img\image-20230417214501573.png)
...
![image-20230417220535101](.\img\image-20230417220535101.png)
...
- `ssh-keygen -t ed25519 -C “your email"` 较多使用
- `ssh-keygen -t rsa -b 2048 -C “your email"`

![image-20230417222555490](.\img\image-20230417222555490.png)

![image-20230417222609542](.\img\image-20230417222609542.png)
...
![image-20230417223912813](.\img\image-20230417223912813.png)

原因：当前分支没有和远程的origin/master分支进行跟踪

- 在没有跟踪的情况下，我们直接执行pull操作的时候必须指定从哪一个远程仓库中的哪一个分支中获取内容；

![image-20230417223931257](.\img\image-20230417223931257.png)
...
![image-20230417224955203](.\img\image-20230417224955203.png)

原因：我们将两个不相干的分支进行了合并：

- https://stackoverflow.com/questions/37937984/git-refusing-to-merge-unrelated-histories-on-rebase

-  简单来说就是：过去git merge允许将两个没有共同基础的分支进行合并，这导致了一个后果：新创建的项目可能被一个毫不 怀疑的维护者合并了很多没有必要的历史，到一个已经存在的项目中，目前这个命令已经被纠正，但是我们依然可以通过`-- allow-unrelated-histories`选项来逃逸这个限制，来合并两个独立的项目；
...
![image-20230417230858328](.\img\image-20230417230858328.png)
...
![image-20230417231715178](.\img\image-20230417231715178.png)

### 6.11、问题

`git config push.default simple`  修改默认push逻辑

- `nothing`  不推送任何东西并有错误提示，除非明确指定分支引用规格
- `current ` 推送当前分支到接收端名字相同的分支。
- `upostream`  推送当前分支到上游@{upstream}
- `simple`   默认模式：在中央仓库工作流程模式下，拒绝推送到上游与本地分支名字不同的分支。
...
- `git push origin v1.0.0`  --- 指定push哪个tag
- `git push origin --targs` --- 常用
...
![image-20230418222547202](.\img\image-20230418222547202.png)
...
![image-20230418223755703](.\img\image-20230418223755703.png)
...
![image-20230418224927200](.\img\image-20230418224927200.png)
...
![image-20230418225854791](.\img\image-20230418225854791.png)
...
![image-20230418230643107](.\img\image-20230418230643107.png)
...
![image-20230418230833312](.\img\image-20230418230833312.png)

### 9.2、比较常见的git flow

![image-20230418231319746](.\img\image-20230418231319746.png)
...
![image-20230419204012507](.\img\image-20230419204012507.png)
...
![image-20230419204305176](.\img\image-20230419204305176.png)
...
![image-20230419205747551](.\img\image-20230419205747551.png)

### 11.3、rebase和merge的选择
...
![image-20230419205832102](.\img\image-20230419205832102.png)

## 12、Git常见命令速查表

![image-20230416230901429](.\img\image-20230416230901429.png)
