...
![image-20230228100443299](./13、JavaScript的BOM操作.assets/image-20230228100443299-7549893.png)
...
这些属性、方法、事件可以在MDN文档：https://developer.mozilla.org/zh-CN/docs/Web/API/Window查看
...
**现location其实是URL的一个抽象实现**

![image-20230228105950862](./13、JavaScript的BOM操作.assets/image-20230228105950862.png)
...
### 5.1、navigator对象（很少使用）

**navigator 对象表示用户代理的状态和标识等信息。**

![image-20230228110409358](./13、JavaScript的BOM操作.assets/image-20230228110409358.png)

### 5.2、screen对象（很少使用）

screen主要记录的是浏览器窗口外面的客户端显示器的信息：比如屏幕的逻辑像素 screen.width、screen.height。

![image-20230228110519439](./13、JavaScript的BOM操作.assets/image-20230228110519439.png)
...
### 6.10、localStorage和sessionStorage的区别
