...
![image-20230501211502509](.\img\image-20230501211502509.png)

那么React的更新流程呢？

![image-20230501211523466](.\img\image-20230501211523466.png)
...
![image-20230501212049229](.\img\image-20230501212049229.png)
...
- 在App中，我们增加了一个计数器的代码；
- 当点击+1时，会重新调用App的render函数； 而当App的render函数被调用时，所有的子组件的render函
  数都会被重新调用；
...
![image-20230501214455991](.\img\image-20230501214455991.png)
...
export class App extends PureComponent {
  ...
  getNativeDOM() {
    ...
    // 2.方式二(推荐): 提前创建好ref对象, createRef(), 将创建出来的对象绑定到元素 
...
![image-20230501233024978](.\img\image-20230501233024978.png)
...
什么是高阶函数？高阶函数的维基百科定义：至少满足以下条件之一：
...
![image-20230502210112077](.\img\image-20230502210112077.png)
...
- 1.识别不安全的生命周期：`UNSAFE_componentWillMount`生命周期
- 2.使用过时的ref API
- 3.检查意外的副作用
