...
![image-20230528201031484](.\img\image-20230528201031484.png)
...
![image-20230528201937332](.\img\image-20230528201937332.png)
...
<img src=".\img\image-20230528204602339.png" alt="image-20230528204602339" style="zoom:67%;" />
...
![image-20230529193827719](.\img\image-20230529193827719.png)

### 4.3、变量的类型推导（推断）

在开发中，有时候为了方便起见我们并不会在声明每一个变量时都写上对应的数据类型，我们更希望可以通过TypeScript本身的特性帮助我们推断出对应的变量类型：

![image-20230529194042102](.\img\image-20230529194042102.png)

如果我们给message赋值123：

![image-20230529194058676](.\img\image-20230529194058676.png)

这是因为在一个变量第一次赋值时，会根据后面的赋值内容的类型，来推断出变量的类型：

- 上面的message就是因为后面赋值的是一个string类型，所以message虽然没有明确的说明，但是依然是一个string类型；

![image-20230529194119576](.\img\image-20230529194119576.png)

## 5、JavaScript数据类型

### 5.1、JavaScript和TypeScript的数据类型

我们经常说TypeScript是JavaScript的一个超级：

![image-20230529195000633](.\img\image-20230529195000633.png)

### 5.2、JavaScript类型 – number类型
...
![image-20230529201632078](.\img\image-20230529201632078.png)

### 5.6、JavaScript类型 – Object类型
...
![image-20230529202914541](.\img\image-20230529202914541.png)

### 5.7、JavaScript类型 – Symbol类型

在ES5中，如果我们是不可以在对象中添加相同的属性名称的，比如下面的做法：

![image-20230529203144035](.\img\image-20230529203144035.png)
...
### 5.8、JavaScript类型 – null和undefined类型
...
never有什么样的应用场景呢？这里我们举个例子，但是它用到了联合类型，后面我们会讲到：
