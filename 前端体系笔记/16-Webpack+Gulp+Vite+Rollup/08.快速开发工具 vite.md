...
![image-20230826170203559](./assets/image-20230826170203559.png)
...
- 基于JavaScript 开发的工具就会开始遇到性能瓶颈:通常需要很长时间(甚至是几分钟!)才能启动开发服务器,即使使用模块热替换(HMR),文件修改后的效果也需要几秒钟才能在浏览器中反映出来。

Vite 旨在利用生态系统中的新进展解决上述问题:

- 浏览器开始原生支持 ES 模块,且越来越多JavaScript 工具使用编译型语言编写。
...
![image-20230826174156542](./assets/image-20230826174156542.png)
...
- 只需要安装postcss,并且配置 postcss.config.js的配置文件即可;
...
![image-20230826202857838](./assets/image-20230826202857838.png)
...
.jsx 和 .tsx文件同样开箱即用,它们也是通过 ESBuild来完成的编译:

- 所以我们只需要直接编写react的代码即可;
- 注意:在index.html加载main.js时,我们需要将main.js的后缀,修改为 main.jsx作为后缀名;
...
![image-20230826203948575](./assets/image-20230826203948575.png)
...
![image-20230826204445335](./assets/image-20230826204445335.png)
